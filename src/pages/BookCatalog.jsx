                        ...
                        <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg maxh-96 overflow-y-auto ">
                            {
                                filteredBooks.slice(0, 5).map(book => (
                                    <Link to={`/books/${book.id}`} key={book.id} className='block px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-0'>
                                        <div className="flex items-center">
                                            <img src={book.coverImage} alt="" className='w-10 h-14 object-cover rounded mr-3' />
                                            <div className="">
